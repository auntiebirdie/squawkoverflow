    ...
    switch (req.body.state) {
      case 'discord':
        ...
        await oauth.tokenRequest({
          ...
          redirectUri: `https://${process.env.NODE_ENV == 'production' ? '' : 'dev.'}squawkoverflow.com/${req.body.connect ? 'settings/connect' : 'login'}`,
          code: req.body.code,
          scope: 'identify',
      ...
      case 'patreon':
        new Promise((resolve, reject) => {
          ...
          request.write(`code=${req.body.code}&grant_type=authorization_code&client_id=${secrets.PATREON.CLIENT_ID}&client_secret=${secrets.PATREON.CLIENT_SECRET}&redirect_uri=https://${process.env.NODE_ENV == 'production' ? '' : 'dev.'}squawkoverflow.com/settings/connect`);
