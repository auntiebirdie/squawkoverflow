  ...
  var faqs = [{
    ...
    },
    {
      ...
      answer: `
        ...
        <p>In your user dropdown, there is a link to <a href="/flocks" target="_blank">Manage Flocks</a> that will take you to a page with a <a class="btn btn-primary btn-sm">New Flock</a> button, which is how you create new flocks. How you want to name your flocks is completely up to you, and can even include emoji!</p>
